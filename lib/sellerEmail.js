...
<body style="margin:0;padding:0;background:#F5F5F3;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif">
  ...
  <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:32px 16px">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff">
      <tr>
        <td style="background:#ffffff;padding:14px 40px;text-align:center;border-bottom:2px solid ${accent}">
          <img src="${LOGO}" alt="Deelmap" height="56" style="display:inline-block;height:56px;width:auto;border:0" />
        </td>
      </tr>
      <tr><td style="padding:32px 40px 24px;background:#ffffff">${body}</td></tr>
      <tr>
...
export function emailSellerWelcome({ name, email }) {
  ...
  const html = shell({
    accent: '#D03839',
    preheader: 'Your Deelmap seller account is ready.',
    body: `
      <p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#A8A8A4">Welcome</p>
      <h1 style="margin:0 0 12px;font-size:22px;font-weight:700;color:#1A1816">Welcome to Deelmap, ${escape((name || '').split(' ')[0] || 'there')}.</h1>
      <p style="margin:0 0 8px;font-size:15px;color:#444441;line-height:1.5">Your seller account is set up. From your dashboard you can post deals, talk to buyers, accept offers and send contracts — all in one place.</p>
      <p style="margin:0 0 8px;font-size:14px;color:#737370">Next up: complete your first listing so verified buyers can see it.</p>
      <p style="margin:16px 0 6px;font-size:13px;font-weight:700;color:#1A1816">Coming soon to Deelmap</p>
      <p style="margin:0 0 8px;font-size:14px;color:#737370;line-height:1.5">We're building tools to help you sell faster — buyer-demand insights so you can source exactly what investors are looking for, smarter buyer matching, and more ways to reach the right buyers. We'll keep you posted as they roll out.</p>
      ${button(`${SELLER_PORTAL}/dashboard`, 'Go to your dashboard')}
    `,
  })
  return { subject, html }
}

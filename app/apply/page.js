    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FAFAF8] p-6">
        <div className="max-w-md w-full bg-white rounded-3xl shadow-xl border border-[#E8E8E4] p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-[#1A1816] mb-3">Application Submitted!</h2>
    ...
    <div className="min-h-screen bg-[#FAFAF8] py-12 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <button
            onClick={() => router.push('/login')}
            className="inline-flex items-center gap-2 text-[#D03839] hover:text-[#E0493B] font-semibold mb-4"
          >
            <ArrowLeft className="w-5 h-5" />
            Back to Login
          </button>
          <h1 className="text-4xl font-bold text-[#1A1816] mb-3">Become a Seller</h1>
          <p className="text-lg text-[#444441]">Join Deelmap and start selling your wholesale deals to verified buyers</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-[#E8E8E4] p-8 lg:p-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#1A1816] mb-4 flex items-center gap-2">
                <Building2 className="w-5 h-5" />
                Business Information
              </h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Business Name *</label>
                  <input
                    type="text"
                    name="businessName"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Business Type *</label>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Contact Person Name *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Email Address *</label>
                  <input
                    type="email"
                    name="email"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Phone Number *</label>
                  <input
                    type="tel"
                    name="phone"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Deals Per Month *</label>
                  <select
                    name="dealsPerMonth"
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Primary Markets *</label>
                  <input
                    type="text"
                    name="primaryMarkets"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-3">Property Types * (Select all that apply)</label>
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Website (Optional)</label>
                  <div className="relative">
                    <Globe className="absolute left-4 top-1/2 -translate-y-1/2 text-[#A8A8A4] w-5 h-5" />
                    <input
                      type="url"
                      name="website"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">LinkedIn Profile (Optional)</label>
                  <div className="relative">
                    <Linkedin className="absolute left-4 top-1/2 -translate-y-1/2 text-[#A8A8A4] w-5 h-5" />
                    <input
                      type="url"
                      name="linkedin"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#444441] mb-2">Tell us about your business (Optional)</label>
                  <textarea
                    name="description"

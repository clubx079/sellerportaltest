  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-xl shadow-lg border border-gray-200 max-w-md w-full p-6 z-10">
          ...
          <div className="py-2.5 px-3 mb-4 bg-gray-50 border border-gray-100 rounded-lg">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={onConfirm}
              className="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-primary hover:bg-primary-600 rounded-lg transition-colors"
            >

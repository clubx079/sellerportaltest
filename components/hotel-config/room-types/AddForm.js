          ...
          >
            ...
            <div className="bg-[#472F97] px-4 sm:px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base sm:text-lg font-semibold text-white">Add Room Type</h2>
                  <p className="text-[10px] sm:text-xs text-white/70">Create new accommodation category</p>
                </div>
              </div>
              <button
                onClick={onClose}

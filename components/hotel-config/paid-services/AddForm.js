...
const AddForm = ({ isOpen, onClose, onSuccess, roomTypes, userId }) => {
          ...
          >
            ...
            <div className="bg-[#472F97] px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-white">Add Paid Service</h2>
                  <p className="text-xs text-neutral-400">Create new service</p>
                </div>
              </div>
              <button
                onClick={onClose}
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-neutral-50 rounded-xl p-4 border border-neutral-200">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <label htmlFor="add-status" className="text-sm font-semibold text-neutral-700">
                      Set as Active
                    </label>
                  </div>
                </div>

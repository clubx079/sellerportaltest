        ...
        <>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-3 sm:p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
              {/* Header */}
              <div className="relative bg-[#111111] p-4 sm:p-6">
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base sm:text-xl font-semibold text-white">Confirm Deletion</h3>
              ...
              <div className="p-4 sm:p-6">
                ...
                <p className="text-xs sm:text-sm text-neutral-500 mt-2 sm:mt-3">
                  This will permanently remove this amenity from your system. All associated data will be lost.
                </p>
              </div>
              ...
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 flex items-center gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm bg-[#111111] hover:bg-[#444444] text-white font-medium rounded-xl transition-colors"
                >
                  Delete
                </button>
              </div>

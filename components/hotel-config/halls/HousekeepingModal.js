...
const HousekeepingModal = ({ isOpen, onClose, onSuccess, hall, employees }) => {
            ...
            <div className="bg-[#472F97] px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/70">Update hall status</p>
                </div>
              </div>
              <button
                onClick={onClose}
                ...
                <div className="bg-neutral-50 rounded-xl p-4 border border-neutral-200">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl font-semibold text-neutral-900">{hall?.hall_number}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs font-medium text-neutral-600 mb-1.5">Hall Type</p>
                      <p className="text-sm font-semibold text-neutral-900">{hall?.hall_types?.title || 'N/A'}</p>
                    </div>
                  </div>
                </div>

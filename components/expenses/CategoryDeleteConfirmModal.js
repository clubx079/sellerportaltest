            ...
            >
              ...
              <div className="p-4 sm:p-6">
                ...
                <p className="text-xs sm:text-sm text-neutral-500 mt-2 sm:mt-3">
                  This will permanently remove this expense category from your system. All associated data will be lost.
                </p>
              </div>
              ...
              <div className="px-4 pb-4 sm:px-6 sm:pb-6 flex flex-col sm:flex-row items-center gap-3">
                ...
                <button
                  ...
                  className="w-full sm:flex-1 px-4 py-2.5 sm:py-3 bg-[#111111] hover:bg-[#444444] text-white text-sm font-semibold rounded-xl transition-colors"
                >
                  Delete
                </button>
              </div>

...
function Fill({ value }) {
  if (value !== undefined && value !== null && String(value).trim() !== '') {
    return <span className="font-semibold text-body">{value}</span>
  }
  return <span className="inline-block align-baseline bg-tint-3 border-b border-mist rounded-[1px]" style={{ minWidth: '64px', height: '0.95em' }}>&#8203;</span>
}
...
export default function LiveContractPreview({ isAssignment, buyerName, sellerName, fieldValues: fv, fullPage = false }) {
    ...
    <>
      ...
      {isAssignment ? (
        <>
          ...
          <p className="mb-1.5 text-smoke-2">Whereas, Assignor wishes to assign its rights, interests and obligations in the Purchase and Sale Contract to Assignee for the final purchase of subject property.</p>
          ...
          <p className="mb-1.5 text-smoke-2"><b className="text-body">2) INSPECTION PERIOD:</b> Assignee waives any inspection period contained in the attached contract. All inspections have been completed prior to the execution of this agreement.</p>
          <p className="mb-1.5 text-smoke-2"><b className="text-body">3) OWNERSHIP &amp; PROPERTY ACCESS ACKNOWLEDGMENT:</b> Assignee acknowledges that Assignor does not authorize Assignee to enter the Subject Property without Assignor&rsquo;s direct authorization, and holds Assignor harmless from related liability.</p>
          <p className="mb-1.5 text-smoke-2">Assignee agrees and accepts all terms and conditions of the subject contract for Purchase and Sale between Buyer and Seller in its entirety.</p>
          <p className="mb-1.5 text-smoke-2"><b className="text-body">4) LIMITATION OF ASSIGNMENT:</b> This Agreement and the subject contract are not assignable by Assignee without the written consent of the Assignor.</p>
          <p className="mb-1.5 text-smoke-2"><b className="text-body">5) DISCLOSURES &amp; ACKNOWLEDGMENT:</b> Assignor makes no warranty regarding inspection or other reports. Assignee is dealing directly with Assignor, is not represented by a real estate agent, and acknowledges receipt of the original Purchase and Sale Contract and all addendums.</p>
          ...
          <p className="mb-3 text-smoke-2">All other terms and conditions of the Subject Purchase and Sale Contract not specifically amended hereby or inconsistent herewith shall remain in full force and effect.</p>
        ...
        <>
          ...
          <p className="mb-1.5 text-smoke-2"><b className="text-body">3) CLOSING COSTS &amp; TAXES:</b> BUYER pays all closing costs, deed prep, and title insurance. Current year taxes are prorated at closing; any previous year&rsquo;s taxes and/or transfer tax to be paid by SELLER.</p>
          <p className="mb-1.5 text-smoke-2"><b className="text-body">4) RENTS &amp; DEPOSITS (if applicable):</b> Rents are prorated at closing and transfer to the BUYER. Tenant deposits per the existing lease also transfer to the BUYER at closing.</p>
          <p className="mb-1.5 text-smoke-2"><b className="text-body">5) TITLE &amp; JUDGMENTS:</b> Seller warrants there are no judgments threatening the equity in the property and no bankruptcy pending. Title is to be free, clear, and unencumbered; all liens shall be paid at closing by the seller.</p>
          ...
          <p className="mb-1.5 text-smoke-2"><b className="text-body">7) CONDITION:</b> Property is sold &ldquo;AS-IS&rdquo; with no warranties by the SELLER, who will disclose any known material defects. Appliances remain with the property unless otherwise stated.</p>
          <p className="mb-1.5 text-smoke-2"><b className="text-body">8) POSSESSION:</b> Possession and occupancy, with all keys and openers, will be delivered to the BUYER when title transfers.</p>
          <p className="mb-1.5 text-smoke-2"><b className="text-body">9) ASSIGNABILITY:</b> This purchase contract IS assignable. SELLER agrees the buyer may place signs and market the property immediately upon acceptance by both parties.</p>
          ...
          <p className="mb-1.5 text-smoke-2"><b className="text-body">12) TIME IS OF THE ESSENCE:</b> Time is of the essence; relevant time periods are calculated in business days.</p>
      ...
      <p className={`${fullPage ? 'text-[11px]' : 'text-[9px]'} font-mono text-mist mt-6 pt-2.5 border-t border-hairline`} style={{ textAlign: 'left' }}>
  ...
  if (fullPage) {
    return (
      <div className="px-8 py-10 sm:px-12 sm:py-14 text-[13px] leading-[1.7] text-body" style={{ fontFamily: 'Georgia, "Times New Roman", serif', textAlign: 'justify' }}>
        {body}
      </div>
    )
  }
  ...
  return (
    <div className="bg-white border-[1.5px] border-ink rounded-[12px] shadow-offset-3 overflow-hidden">
      <div className="px-4 py-2 bg-tint-3 border-b-[1.5px] border-ink flex items-center gap-2">
        <FileText className="w-3.5 h-3.5 text-muted" />
        <span className="font-mono text-[10.5px] font-semibold text-muted uppercase tracking-[0.08em]">Live preview · the actual contract, filling in as you type</span>
      </div>
      <div className="px-6 py-5 max-h-[74vh] overflow-y-auto text-[11px] leading-[1.55] text-body" style={{ fontFamily: 'Georgia, "Times New Roman", serif', textAlign: 'justify' }}>
        {body}
      </div>
    </div>
  )

...
export default function DashboardLayout({ children }) {
  ...
  useEffect(() => {
    const isPublicPage = ['/login', '/register', '/forgot-password', '/'].includes(pathname) || pathname.startsWith('/onboarding') || pathname.startsWith('/properties/preview') || pathname.startsWith('/auth/') || pathname.startsWith('/team/accept')

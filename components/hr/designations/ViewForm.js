...
const ViewForm = ({ isOpen, onClose, designation }) => {
          ...
          >
            ...
            <div className="bg-[#472F97] px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <h2 className="text-base sm:text-lg font-semibold text-white">Designation Details</h2>
                  <p className="text-[10px] sm:text-xs text-white/70">View designation information</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div className="bg-neutral-50 rounded-xl p-4 border border-neutral-200">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-neutral-600 mb-1">Designation Name</label>

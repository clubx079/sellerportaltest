...
const EditForm = ({ isOpen, onClose, onSuccess, department }) => {
          ...
          >
            ...
            <div className="bg-[#111111] px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <h2 className="text-base sm:text-lg font-semibold text-white">Edit Department</h2>
                  <p className="text-[10px] sm:text-xs text-white/70">Update department details</p>
                </div>
              </div>
              <button
                onClick={onClose}
                ...
                <div className="bg-neutral-50 rounded-xl p-4 border border-neutral-200">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-neutral-700 mb-1.5">
                      Department Name <span className="text-neutral-500">*</span>
                    </label>
                    <input
                      type="text"
                      value={formData.name}

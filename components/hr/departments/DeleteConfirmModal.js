            ...
            >
              ...
              <div className="p-4 sm:p-6">
                ...
                <p className="text-xs sm:text-sm text-neutral-500 mt-2 sm:mt-3">
                  This will permanently remove this department from your system. All associated data will be lost.
                </p>
              </div>
              ...
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 flex items-center gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base bg-[#111111] hover:bg-[#444444] text-white font-medium rounded-lg sm:rounded-xl transition-colors"
                >
                  Delete
                </button>
              </div>

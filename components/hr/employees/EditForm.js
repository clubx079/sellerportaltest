...
const EditForm = ({ isOpen, onClose, onSuccess, employee, departments = [], designations = [] }) => {
          ...
          >
            ...
            <div className="bg-[#111111] px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <h2 className="text-base sm:text-lg font-semibold text-white">Edit Employee</h2>
                  <p className="text-[10px] sm:text-xs text-white/70">Update employee details</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
              ...
              <div className="sticky bottom-0 bg-white border-t border-neutral-200 px-4 sm:px-6 py-3 sm:py-4 flex items-center gap-2 sm:gap-3">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="flex-1 px-3 sm:px-4 py-2 sm:py-2.5 bg-[#111111] hover:bg-[#444444] text-white text-sm sm:text-base font-medium rounded-lg sm:rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
